...
public class RequestManager {
    ...
    private String url_base = "api.appnapkin.net/v1";
        ...
        try {
            ...
            if (method.equals("GET")) {
                ...
                if (params_body_string == null) {
                     ...
                     */
                    if (blockRedirect) {
                        HttpClientParams.setRedirecting(httpPut.getParams(), false);
                    }

                } else {
                    httpPut.setEntity(new StringEntity(params_body_string));
                }
